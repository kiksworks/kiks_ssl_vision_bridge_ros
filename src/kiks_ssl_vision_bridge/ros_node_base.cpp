...
void RosNodeBase::add_parameter(std::string name, T default_value, SetParamFunc set_param_func) {
  auto add_parameter_one_name = [this, set_param_func](const std::string& name, T default_value) {
    default_value = node_->has_parameter(name) ?
      node_->get_parameter(name).get_value<T>() :
...
rcl_interfaces::msg::SetParametersResult RosNodeBase::set_parameters(std::vector<rclcpp::Parameter> parameters) {
...
template void RosNodeBase::add_parameter<std::vector<std::uint8_t>>(std::string, std::vector<std::uint8_t>, SetParamFunc);
template void RosNodeBase::add_parameter<std::vector<bool>>(std::string, std::vector<bool>, SetParamFunc);
template void RosNodeBase::add_parameter<std::vector<std::int64_t>>(std::string, std::vector<std::int64_t>, SetParamFunc);
template void RosNodeBase::add_parameter<std::vector<double>>(std::string, std::vector<double>, SetParamFunc);
template void RosNodeBase::add_parameter<std::vector<std::string>>(std::string, std::vector<std::string>, SetParamFunc);
